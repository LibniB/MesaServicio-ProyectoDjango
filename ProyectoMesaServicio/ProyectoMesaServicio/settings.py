...
SECRET_KEY = 'django-insecure-*i1whwh@9a75z60+v#^=w195px)b!*va+7g+-y8yw(_v%t)z76'
...
STATIC_URL = '/static/'
# Set the absolute file path where static files are stored
